...
public class RecivedEmailAdapter extends RecyclerView.Adapter<RecivedEmailAdapter.MyViewHolder> {
    ...
    public RecivedEmailAdapter(Context mContext, ArrayList<Commentdata> emailList) {
