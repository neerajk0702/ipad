...
public class FZProgressBar extends LinearLayout {
    ...
    public void bar_config(
        ...
        switch (BAR_SIZE_W) {
            case 0:
                limits_params =
                        new LayoutParams(LayoutParams.FILL_PARENT, BAR_SIZE_H);
                break;
            default:
                limits_params =
                        new LayoutParams(BAR_SIZE_W, BAR_SIZE_H);
                break;
        }
    ...
    public synchronized void animation_start(final Mode mode) {
        ...
        basic_one = new Runnable() {
            ...
            public void run() {
                LayoutParams params =
                        new LayoutParams(i+=ANIMATION_SPACING, BAR_SIZE_H);
        ...
        if(mode == Mode.DETERMINATE) {
            LayoutParams params =
                    new LayoutParams(bar.getWidth()+ANIMATION_SPACING, BAR_SIZE_H);
            bar.setLayoutParams(params);
        } else {
