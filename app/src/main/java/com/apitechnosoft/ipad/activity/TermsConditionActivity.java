...
public class TermsConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ASTUtil.isTablet(TermsConditionActivity.this)) {
    ...
    public void getAllNotification() {
        try {
            ...
            if (ASTUIUtil.isOnline(TermsConditionActivity.this)) {
                final ASTProgressBar dotDialog = new ASTProgressBar(TermsConditionActivity.this);
                // dotDialog.show();

                ServiceCaller serviceCaller = new ServiceCaller(TermsConditionActivity.this);
